package com.project.negocio.view;
...
import com.project.negocio.contato.AtualizarContato;
import com.project.negocio.contato.Contato;
import com.project.negocio.contato.ContatoDao;
import com.project.negocio.contato.InserirContato;
...
public class ListarContato extends JFrame {
	...
	public static void pesquisar(DefaultTableModel modelo) {
		...
		for (Contato c : dao.getContatos()) {
			...
			c.getTelefone(), c.getEmail(), c.getRua(), c.getNumero(), c.getValor(), c.getDesconto(), c.getValortotal()});
		}
	}
